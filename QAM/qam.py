...
class qam(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_2_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Quadrature Phase Component", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_time_sink_x_2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 3500, 5000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 3500, 5000, window.WIN_HAMMING, 6.76))
