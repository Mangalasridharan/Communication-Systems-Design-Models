...
class qam16(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_c([-1-1j, -1+1j, 1+1j, 1-1j,-3-3j,-3+3j,3-3j,3+3j,-1-3j,-1+3j,1-3j,1+3j,-3-1j,-3+1j,3-1j,3+1j], True, 1, [])
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 7500, 0.5, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 7500, 0.5, window.WIN_HAMMING, 6.76))
