...
class PSK_constellation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSK_constellation")
...
def main(top_block_cls=PSK_constellation, options=None):
