...
class binary antipodal signal detection(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "binary antipodal signal detection")
        ...
        self.digital_map_bb_0 = digital.map_bb((1,4))
...
def main(top_block_cls=binary antipodal signal detection, options=None):
