...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_5_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 30000, 1, 0, 0)
        self.analog_sig_source_x_5 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 30000, 1, 0, 0)
        self.analog_sig_source_x_4_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20000, 1, 0, 0)
        self.analog_sig_source_x_4 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 20000, 1, 0, 0)
        self.analog_sig_source_x_3_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 1, 0, 0)
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 2000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_multiply_xx_0_1, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_multiply_xx_0_0, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_3_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.analog_sig_source_x_4, 0), (self.blocks_multiply_xx_0_1, 1))
        self.connect((self.analog_sig_source_x_4_0, 0), (self.blocks_multiply_xx_1_0, 1))
        self.connect((self.analog_sig_source_x_5, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.analog_sig_source_x_5_0, 0), (self.blocks_multiply_xx_1_1, 1))
        self.connect((self.band_pass_filter_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.band_pass_filter_0_0, 0), (self.blocks_multiply_xx_1_0, 0))
        self.connect((self.band_pass_filter_0_1, 0), (self.blocks_multiply_xx_1_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_1_1, 0), (self.low_pass_filter_0_1, 0))
        ...
        self.connect((self.low_pass_filter_0_1, 0), (self.qtgui_freq_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_4_0.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_5.set_sampling_freq(self.samp_rate)
        self.analog_sig_source_x_5_0.set_sampling_freq(self.samp_rate)
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 9900, 11000, 100, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, 18000, 22000, 100, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_1.set_taps(firdes.band_pass(1, self.samp_rate, 27000, 33000, 100, window.WIN_HAMMING, 6.76))
        self.iio_pluto_sink_0.set_samplerate(self.samp_rate)
        self.iio_pluto_source_0.set_samplerate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1000, 50, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 2000, 50, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1.set_taps(firdes.low_pass(1, self.samp_rate, 3000, 50, window.WIN_HAMMING, 6.76))
