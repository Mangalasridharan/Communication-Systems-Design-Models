...
class TDM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TDM")
        ...
        self.qtgui_freq_sink_x_0_2 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "Multiplexed signal-Frequency", #name
            1,
            None # parent
        )
        ...
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_float*1, (2, 2,2))
        self.blocks_stream_demux_0 = blocks.stream_demux(gr.sizeof_float*1, (2,2,2))
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 3000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_stream_mux_0, 1))
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_stream_mux_0, 2))
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_stream_demux_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.blocks_stream_demux_0, 2), (self.qtgui_time_sink_x_1_0, 2))
        self.connect((self.blocks_stream_demux_0, 1), (self.qtgui_time_sink_x_1_0, 1))
        self.connect((self.blocks_stream_demux_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.qtgui_freq_sink_x_0_2, 0))
...
def main(top_block_cls=TDM, options=None):
