...
# Title: Under amplitude modulation
# Author: Mangal
...
class undermodulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Under amplitude modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Under amplitude modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "undermodulation")
        ...
        self.iio_pluto_source_0.set_filter_params('Auto', '', 0, 34000)
        ...
        self.iio_pluto_sink_0.set_frequency(1000000000)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 340000, 68, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 340000, 68, 0, 0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_multiply_xx_2, 0))
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_float_to_complex_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 34000, 50, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=undermodulation, options=None):
