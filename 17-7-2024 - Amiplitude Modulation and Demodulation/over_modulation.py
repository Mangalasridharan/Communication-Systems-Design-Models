...
# Title: Over amplitude modulation
# Author: Mangal
...
class over_modulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Over amplitude modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Over amplitude modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "over_modulation")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 340000, 22.7, 0, 0)
...
def main(top_block_cls=over_modulation, options=None):
