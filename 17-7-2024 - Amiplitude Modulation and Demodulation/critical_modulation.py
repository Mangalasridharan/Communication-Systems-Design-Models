...
# Title: Critical Amplitude modulation
# Author: Mangal
...
class critical_modulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Critical Amplitude modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Critical Amplitude modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "critical_modulation")
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 340000, 34, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 340000, 34, 0, 0)
...
def main(top_block_cls=critical_modulation, options=None):
