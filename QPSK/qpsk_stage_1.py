...
class qpsk_stage_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_stage_1")
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 4, 5000))), True)
        ...
        self.connect((self.blocks_stream_demux_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.blocks_stream_demux_0, 1), (self.blocks_uchar_to_float_1, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_stream_demux_0, 0))
...
def main(top_block_cls=qpsk_stage_1, options=None):
