...
class q1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Modulated and input signal", #name
            3, #number of inputs
            None # parent
        )
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_time_sink_x_1, 1))
