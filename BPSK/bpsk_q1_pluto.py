...
class bpsk_q1_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "bpsk_q1_pluto")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 650000
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 500, 2, (-1), 180)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10000, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 500, 10, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=bpsk_q1_pluto, options=None):
